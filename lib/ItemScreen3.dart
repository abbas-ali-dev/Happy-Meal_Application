...
import 'package:happy_meal/AddToCart3.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Snacks', style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold,)),
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            SizedBox(height: 10,),
            Text('Tasty Fries with Tomato Souce', style: TextStyle(fontSize: 17,),
            ...
            Row(
              ...
              children: [
                ...
                Column(
                  children: [
                    Text('Box Size', style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold),),
                    SizedBox(height: 5,),
                    Text('Medium', style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold),)
                  ],
                )
              ],
            ),
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        Text('250/-rs', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.red,), ),
                      ],
                    )
                  ],
                )),
      ...
      bottomNavigationBar: InkWell(
        onTap: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) => AddToCart3(),));
        },
        child: Container(
          height: 60,
