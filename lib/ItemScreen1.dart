    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            SizedBox(height: 10,),
            Text('Mized Burger With Beef, Chilli & Spicy', style: TextStyle(fontSize: 17,),
              ...
              children: [
                Column(
                  children: [
                    ...
                    SizedBox(height: 5,),
                    Text('130', style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold),)
                  ],
                ),
                Container(
                  height: 30,
                ...
                Column(
                  children: [
                    ...
                    SizedBox(height: 5,),
                    Text('Double Pati', style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold),)
                  ],
                )
              ],
            ),
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        Text('950/-rs', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.red,), ),
                      ],
                    )
                  ],
                )),
